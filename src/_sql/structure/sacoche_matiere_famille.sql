...
CREATE TABLE sacoche_matiere_famille (
  ...
  matiere_famille_categorie TINYINT(1)  UNSIGNED                NOT NULL DEFAULT 0 COMMENT "1 = Enseignements usuels ; 2 = Enseignements généraux ; 3 = Enseignements spécifiques ; 4 = Enseignements complémentaires",
