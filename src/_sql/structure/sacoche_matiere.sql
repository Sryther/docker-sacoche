...
CREATE TABLE sacoche_matiere (
  matiere_id          SMALLINT(4) UNSIGNED                NOT NULL AUTO_INCREMENT,
  ...
  matiere_nb_demandes TINYINT(2)  UNSIGNED                NOT NULL DEFAULT 0,
  ...
  matiere_nom         VARCHAR(67) COLLATE utf8_unicode_ci NOT NULL DEFAULT "",
