...
(
  function()
  {
    ...
    // ////////////////////////////////////////////////////////////////////////////////////////////////////
    // Afficher / masquer le choix des profils
    // ////////////////////////////////////////////////////////////////////////////////////////////////////

    function profils()
    {
      if($('#f_profil_ALL').is(':checked'))
      {
        $('label[for^=f_profil_]').hide();
        $('label[for=f_profil_ALL]').show();
      }
      else
      {
        $('label[for^=f_profil_]').show();
      }
    }
    ...
    (
      {
        rules :
        {
          ...
          f_motif      : { required:function(){return $('#f_bloquer').is(':checked');} },
          'f_profil[]' : { required:function(){return $('#f_bloquer').is(':checked');} }
        },
        messages :
        {
          f_action     : { required:"choix manquant" },
          f_motif      : { required:"motif manquant" },
